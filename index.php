        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($downloads as $download) { ?>
                    <?php if (array_key_exists('bittorrent', $download)) { ?>
                        ...
                        <tr>
                            ...
                            <td width="300">
                                ...
                                <span class="center-block small">&nbsp;</span>
                                <span class="center-block small">Files:</span>
                                <?php foreach($download['files'] as $file) {?>
                                    <label class="center-block small text-nowrap"><?=str_replace(DOWNLOAD_PATH,'',$file['path'])?></label>
                                <?php } ?>
                                </div>
                            </td>
                            <td width="150">
                                ...
                                <div class="btn-group">
                                    <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=moveup"
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=movetop">
                                                <i class="fa fa fa-angle-double-up"></i>
                                                Move top
                                            </a>
                                        </li>
                                        <li>
                                            <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=movedown">
                                                <i class="fa fa fa-angle-down"></i>
                                                Move down
                                            </a>
                                        </li>
                                        <li>
                                            <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=movebottom">
                            ...
                            <td width="140">
                                ...
                                <div class="btn-group">
                                    ...
                                    if ($download['status'] == 'paused') {
                                        ?>
                                        <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=resume"
                                           class="btn btn-default">
                                            <i class="fa fa-play"></i>
                                            Resume
                                        </a>
                                    <?php } elseif ($download['status'] == 'active' || $download['status'] == 'waiting') { ?>
                                        <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=pause"
                                           class="btn btn-default">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="action.php?type=<?=$_GET['type']?>&gid=<?= $download['gid'] ?>&action=remove">

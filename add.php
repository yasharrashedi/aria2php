			...
			<div class="col-md-12">
				...
				<fieldset>
					...
					<form method="post">
						...
						<br> <input type="submit" value="Add download link"
				...
				<fieldset>
					...
					<form method="post">
						Download Links:
						<textarea class="form-control" name="multiuri"></textarea>

						<br> <input type="submit" value="Add multiple download links"
							class="btn btn-success">
					</form>
				</fieldset>
				...
				<fieldset>
					...
					<form method="post" enctype="multipart/form-data">
						Torrent file: <input type="file" name="torrent"> <br> <input
							type="submit" value="Add torrent" class="btn btn-success">
					</form>
				</fieldset>
			</div>
			<!--/row-->
